...
dashboard. Habitat Explorer v4 / MCP `2.0.2` is deployed but has not been
resubmitted; do not claim that candidate as an approved ChatGPT App version
until OpenAI accepts the new submission.
