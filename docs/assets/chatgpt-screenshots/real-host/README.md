...
approved Atlarium app version `1.0.0` and the live MCP `2.0.2` endpoint. The
separate App version `2.0.2` remains a draft and is not approved.
...
errors, while the `2.0.2` draft endpoint rescan found all 39 tools. The cause of
