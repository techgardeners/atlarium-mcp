...
Last updated: `2026-08-18T18:01:00Z`
...
| ChatGPT App | OpenAI Platform Apps review portal | Existing app `1.0.0` approved; signed-in `2.0.3` draft saved with verified domain, 39-tool rescan, three uploaded 706px ChatGPT-hosted screenshots and a real 1080x1920 responsive-web demo | Keep production endpoint green and deterministic validation passing | OpenAI account for native iOS/Android recording, release-note correction, review replies and final submit | `chatgpt-app-submission.json`, `docs/assets/chatgpt-app-demo.mp4`, `docs/chatgpt-mobile-video.md`, `docs/assets/chatgpt-screenshots/real-host/`, `docs/assets/chatgpt-screenshots/submission/` | Record the same flow in native ChatGPT mobile, correct the release notes to `2.0.3`, review every generated field, then submit the candidate after explicit confirmation. |
