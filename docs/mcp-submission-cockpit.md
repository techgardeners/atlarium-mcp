...
| mcpservers.org | https://mcpservers.org/search | Submitted / pending review | Monitor public listing and approval email | External review queue | `tmp/directory-submissions/secondary-directory-payloads.md` | Submitted via free form; page confirmed `Submission Successful` and review within 12 hours. Verify listing URL before marking accepted. |
