...
| Smithery | https://smithery.ai/servers/ilgrafico79/atlarium-habitat-database | Created / release success / unlisted | Keep release metadata healthy and prepare final publish | User confirmation needed for final Publish/visibility under namespace `ilgrafico79` | `tmp/directory-submissions/secondary-directory-payloads.md` after `pnpm directories:submit -- --payload` | Click final Publish and keep listing visible only after explicit confirmation. |
