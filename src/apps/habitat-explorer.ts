export const habitatExplorerResourceUri = "ui://widget/habitat-explorer.v3.html";
...
export const habitatExplorerResourceMeta = {
  ...
  description:
    "Interactive read-only habitat cards for species, plants, diagnostics, products, calculators, fertilization and tank suggestions.",
  ...
  _meta: {
    ...
    "openai/widgetDescription":
      "Render Atlarium public habitat data as searchable cards, profile panels, diagnostic summaries, product results, calculator outputs and compatibility plans.",
      ...
      const uiCopy = {
        en: {
          ...
          tools: {
            ...
            get_guide: "Care guide",
            search_algae: "Algae search",
            get_algae_profile: "Algae profile",
            search_diseases: "Disease search",
            get_disease_profile: "Disease profile",
            search_plant_problems: "Plant problem search",
            get_plant_problem_profile: "Plant problem profile",
            search_medicines: "Medicine search",
            get_medicine_profile: "Medicine profile",
            match_diagnostic_profiles: "Diagnostic match",
            list_product_categories: "Product categories",
            list_product_brands: "Product brands",
            search_equipment: "Equipment search",
            get_equipment_profile: "Equipment profile",
            search_fertilizers: "Fertilizer search",
            get_fertilizer_profile: "Fertilizer profile",
            search_fertilization_regimes: "Fertilization regimes",
            get_fertilization_regime: "Fertilization regime",
            calculate_fertilizer_dose: "Fertilizer dose",
            calculate_nutrient_gaps: "Nutrient gaps",
            calculate_weekly_dose_totals: "Weekly dose totals",
            generate_fertilization_plan: "Fertilization plan",
            calculate_tank_volume: "Tank volume",
            calculate_tank_weight: "Tank weight",
            calculate_water_change: "Water change",
            calculate_water_chemistry: "Water chemistry",
            convert_units: "Unit conversion",
            calculate_equipment_requirements: "Equipment requirements",
            suggest_habitat_for_tank: "Habitat plan"
          },
          values: {
        ...
        it: {
          ...
          tools: {
            ...
            get_guide: "Guida di cura",
            search_algae: "Ricerca alghe",
            get_algae_profile: "Profilo alga",
            search_diseases: "Ricerca malattie",
            get_disease_profile: "Profilo malattia",
            search_plant_problems: "Ricerca problemi piante",
            get_plant_problem_profile: "Profilo problema pianta",
            search_medicines: "Ricerca medicinali",
            get_medicine_profile: "Profilo medicinale",
            match_diagnostic_profiles: "Match diagnostico",
            list_product_categories: "Categorie prodotti",
            list_product_brands: "Brand prodotti",
            search_equipment: "Ricerca attrezzature",
            get_equipment_profile: "Profilo attrezzatura",
            search_fertilizers: "Ricerca fertilizzanti",
            get_fertilizer_profile: "Profilo fertilizzante",
            search_fertilization_regimes: "Regimi fertilizzazione",
            get_fertilization_regime: "Regime fertilizzazione",
            calculate_fertilizer_dose: "Dose fertilizzante",
            calculate_nutrient_gaps: "Carenze nutrienti",
            calculate_weekly_dose_totals: "Totali dose settimanale",
            generate_fertilization_plan: "Piano fertilizzazione",
            calculate_tank_volume: "Volume vasca",
            calculate_tank_weight: "Peso vasca",
            calculate_water_change: "Cambio acqua",
            calculate_water_chemistry: "Chimica acqua",
            convert_units: "Conversione unità",
            calculate_equipment_requirements: "Requisiti attrezzatura",
            suggest_habitat_for_tank: "Piano habitat"
          },
          values: {
        ...
        es: {
          ...
          tools: {
            ...
            get_guide: "Guía de cuidado",
            search_algae: "Búsqueda de algas",
            get_algae_profile: "Perfil de alga",
            search_diseases: "Búsqueda de enfermedades",
            get_disease_profile: "Perfil de enfermedad",
            search_plant_problems: "Búsqueda de problemas de plantas",
            get_plant_problem_profile: "Perfil de problema de planta",
            search_medicines: "Búsqueda de medicamentos",
            get_medicine_profile: "Perfil de medicamento",
            match_diagnostic_profiles: "Coincidencia diagnóstica",
            list_product_categories: "Categorías de productos",
            list_product_brands: "Marcas de productos",
            search_equipment: "Búsqueda de equipos",
            get_equipment_profile: "Perfil de equipo",
            search_fertilizers: "Búsqueda de fertilizantes",
            get_fertilizer_profile: "Perfil de fertilizante",
            search_fertilization_regimes: "Regímenes de fertilización",
            get_fertilization_regime: "Régimen de fertilización",
            calculate_fertilizer_dose: "Dosis de fertilizante",
            calculate_nutrient_gaps: "Déficits de nutrientes",
            calculate_weekly_dose_totals: "Totales semanales",
            generate_fertilization_plan: "Plan de fertilización",
            calculate_tank_volume: "Volumen del acuario",
            calculate_tank_weight: "Peso del acuario",
            calculate_water_change: "Cambio de agua",
            calculate_water_chemistry: "Química del agua",
            convert_units: "Conversión de unidades",
            calculate_equipment_requirements: "Requisitos de equipo",
            suggest_habitat_for_tank: "Plan de hábitat"
          },
          values: {
